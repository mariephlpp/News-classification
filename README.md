...
We enjoyed working on this project as it allowed us to apply algorithms that we already knew to text classfication, but also to discover new ones that are specific to text classification.
